...
const Show=({word,state})=>{
  if (state === true){
    ...
    return(<p>{"___ ".repeat(word.length)}</p>)
  }
...
// const ref = db.firestore().collection("students").doc();
  ...
  <div>
    ...
    <p>level 1</p>
    <img src={l1imagelink} alt="l1image" height={200} width={400}/>
    <Hinter state1 ={l1word1s} state2 ={l1word2s} state3={l1word3s} state4={l1word4s} hint1={l1hint1} hint2={l1hint2} hint3={l1hint3} hint4 ={l1hint4}/>
    <div>
      <form onSubmit={onSubmit}>
       Guess <input value={answerInput} onChange={inputChange}/>
       <div>
    ...
    return(
      <div>
        ...
        <p>level 2</p>
        <img src={l2imagelink} alt="l2image" height={200} width={400}/>
        <Hinter state1 ={l2word1s} state2 ={l2word2s} state3={l2word3s} state4={l2word4s} hint1={l2hint1} hint2={l2hint2} hint3={l2hint3} hint4 ={l2hint4}/>
        <div>
          <form onSubmit={onSubmit}>
           Guess <input value={answerInput} onChange={inputChange}/>
           <div>
    ...
    return(
      <div>
        ...
        <p>level 3</p>
        <img src={l3imagelink} alt="l3image" height={200} width={400}/>
        <Hinter state1 ={l3word1s} state2 ={l3word2s} state3={l3word3s} state4={l3word4s} hint1={l3hint1} hint2={l3hint2} hint3={l3hint3} hint4 ={l3hint4}/>
        <div>
          <form onSubmit={onSubmit}>
           Guess <input value={answerInput} onChange={inputChange}/>
           <div>
  ...
  return(
    <div>
      ...
      <p>level 4</p>
      <img src={l4imagelink} alt="l4image" height={200} width={400}/>
      <Hinter state1 ={l4word1s} state2 ={l4word2s} state3={l4word3s} state4={l4word4s} hint1={l4hint1} hint2={l4hint2} hint3={l4hint3} hint4 ={l4hint4}/>
      <div>
        <form onSubmit={onSubmit}>
         Guess <input value={answerInput} onChange={inputChange}/>
         <div>
    ...
    return(
      <div>
        ...
        <p>level 5</p>
        <img src={l5imagelink} alt="l5image" height={200} width={400}/>
        <Hinter state1 ={l5word1s} state2 ={l5word2s} state3={l5word3s} state4={l5word4s} hint1={l5hint1} hint2={l5hint2} hint3={l5hint3} hint4 ={l5hint4}/>
        <div>
          <form onSubmit={onSubmit}>
           Guess <input value={answerInput} onChange={inputChange}/>
           <div>
